...
function App() {
  ...
  return (
    <div className="mt-10 mx-auto sm:my-auto sm:flex sm:justify-center sm:flex-col sm:items-center sm:mt-14 md:mt-10 lg:mt-0 absolute inset-0 -z-10 h-[2000px] md:h-[1070px] lg:h-full w-full bg-white [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#0CD_100%)]">
